...
public class Solution2864 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < numbers.length; i++) {
            int num1, num2;
            if (i == 0) {
                num1 = Integer.parseInt(numbers[0].replace('6', '5'));
                num2 = Integer.parseInt(numbers[1].replace('6', '5'));
                bufferedWriter.write((num1 + num2) + " ");
            }
            if (i == 1) {
                num1 = Integer.parseInt(numbers[0].replace('5', '6'));
                num2 = Integer.parseInt(numbers[1].replace('5', '6'));
                bufferedWriter.write((num1 + num2) + "\n");
            }
        }
